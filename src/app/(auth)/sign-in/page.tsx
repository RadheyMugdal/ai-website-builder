    ...
    <main className=" w-screen h-screen  grid md:grid-cols-2 p-2">
      <div className="flex flex-col order-2  md:order-1 gap-6 p-4  sm:p-12 lg:p-28 md:justify-center ">
        <div className=" space-y-2">
          ...
          <p className="text-sm  opacity-80">Sign in to keep building smarter, faster, and beautifully with Wavely.</p>
        </div>
        ...
        <div>
          <p className=" text-sm opacity-80 text-center">Don't have an account? {" "}

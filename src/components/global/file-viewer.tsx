...
function Tree({
  ...
  // Removed the useEffect that automatically expanded all items
  return (
...
function FileTree({
  ...
  // Removed the automatic expansion logic - now starts collapsed
  return (
    <div className="w-full h-full border-r">
      ...
      <ScrollArea className=" h-[94%] ">
        <div className="p-2">
          <Tree
            elements={tree}
            initialExpandedItems={[]} // Start with no expanded items
